...
public_users.get('/isbn/:isbn', async function (req, res) {
    ...
    try {
        const selectedBook = await new Promise(() => {
...
public_users.get('/author/:author', async function (req, res) {
    ...
    const booksList = await new Promise((resolve, reject) => {
        resolve(Object.values(books).filter(item => item.author.toLowerCase().includes(author.toLowerCase())))
    })
...
public_users.get('/title/:title', async function (req, res) {
    ...
    const booksList = await new Promise((resolve, reject) => {
        resolve(Object.values(books).filter(item => item.title.toLowerCase().includes(title.toLowerCase())))
    })
